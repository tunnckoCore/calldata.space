        ...
        <div className="mx-auto flex flex-col items-center">
          <div className="flex w-11/12 flex-col gap-y-3">
            <div className="flex items-center justify-between align-middle">
              ...
              >
                <a href="https://calldata.space">calldata.space</a>
              </h1>
            ...
            <div className="group flex max-w-full">
              <label htmlFor="searchquery" className="sr-only">Search Ethscriptions Ecosystem</label>
              <input
                id="searchquery"
                name="searchquery"
                type="text"
          ...
          <div className="my-5 flex w-full items-center justify-center">
            <dl className="grid w-11/12 grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {features.map((x, idx) => <CustomCard key={idx} {...x} />)}
            </dl>
          </div>
        </div>
      </div>
