export const features = [
  ...
  },
  {
    ...
    text: `Learn what are Ethscriptions and how they work. What are the differences
            ...
            platform to create an Ethscription or launch your first project.`,
    icon: `<svg class="h-6 w-6 text-white" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
  ...
  },
  {
    ...
    external: true,
    title: 'Develop',
    text: `Are you a developer? We have powerful APIs, tools, and extensive docs. We also
            support for Webhooks, Server Sent Events, Websockets, and more. Learn from the
            people building on the protocol since day one.`,
    icon: `<svg class="h-6 w-6 text-white" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" stroke-linecap="round" stroke-linejoin="round"></path>
          </svg>`,
  },
  {
    title: 'Create & Launch',
  ...
  },
  {
    ...
    text: `Everything we build is fully Free and Open Source software. Built by veterans in
            the open source space. You can self-host all the things yourself and deploy on
            your own infrastructure with one-click.`,
    icon: `<svg class="h-6 w-6 text-white" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
  ...
  {
    title: 'Auction House',
    text: `Create an Everybody Wins auctions for your Ethscriptions. Wait, what?! Yes, a
            fun and safe way to make a living by just betting, there's no way to loose -
            you're rewarded on top of your bid when someone outbids you.`,
    icon: `<svg class="h-6 w-6 text-white" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
  ...
  {
    href: 'https://gist.github.com/tunnckoCore/04ce9e5b8f5b5523af65f58b9d0d6eec',
    external: true,
    title: 'Safe Markets',
    text: `Have your own safe and secure, user-owned and user-controlled marketplaces. Have
            a collection? Okay, have a specific collection market. Avoid censorship and
            security holes.`,
    icon: `<svg class="h-6 w-6 text-white" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
