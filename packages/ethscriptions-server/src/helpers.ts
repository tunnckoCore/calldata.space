...
import { Hono, MiddlewareHandler, type Context, type ValidationTargets } from 'hono';
...
export function createApp(cors: any = null): Hono<{ Bindings: Bindings & Env }> {
...
export function toHonoHandler(fn: any): MiddlewareHandler {
